									...
									<form action="<?= base_url('barang/proses_tambah') ?>" id="form-tambah" method="POST">
										<div class="form-row">
											<div class="form-group col-md-6">
												...
												<input type="text" name="kode_barang" placeholder="Masukkan Kode Barang" autocomplete="on" class="form-control" required value="<?= mt_rand(10000000, 99999999) ?>" maxlength="8" readonly>
											</div>
											<div class="form-group col-md-6">
										...
										<div class="form-row">
											...
											<div class="form-group col-md-6">
												...
												<select name="satuan" id="satuan" class="form-control" required>
													...
													<option value="bungkus">BKS</option>
